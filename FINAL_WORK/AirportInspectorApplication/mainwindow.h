...
private:
   ...
   // void DisplayDestinations(QString row);
    ...
    QString _qrArrivals = QString("SELECT flight_no, scheduled_arrival, ad.airport_name->>'ru' "
                            "as \"Name\" from bookings.flights f "
                            "JOIN bookings.airports_data ad on ad.airport_code = f.departure_airport "
                                  "WHERE f.arrival_airport  = '%1'");

    QString _qrDepartures = "SELECT flight_no, scheduled_departure, ad.airport_name->>'ru' as \"Name\" "
